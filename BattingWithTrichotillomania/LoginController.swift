...
class LoginController: UIViewController {
    ...
    var recordsHistoryController: RecordsHistoryViewController?
    ...
    func handleLogin() {
        ...
        Auth.auth().signIn(withEmail: email, password: password, completion: { (user, error) in
            ...
            self.recordsHistoryController?.fetchCurrentUserProfileAndSetupNavBarTitle()
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "lucyhan_logo")
    ...
    lazy var tipsLabel : UILabel = {
        ...
        label.text = "my story of why make this app ..."
        ...
        let guestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(tipsLabelClicked(_:)))
    ...
    let projectImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "BWT_logo")
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.contentMode = .scaleAspectFit
    ...
    @objc func handleLoginRegisterChange() {
        ...
        profileImageHeightAnchor = profileImageView.heightAnchor.constraint(equalTo: inputsContainerView.heightAnchor, multiplier: loginRegisterSegmentedControl.selectedSegmentIndex == 0 ? 0 : 1/4)
    ...
    func setupLogoImageView() {
        //need x, y, width, height constraints
        projectImageView.topAnchor.constraint(equalTo: view.topAnchor, constant: 20).isActive = true
        projectImageView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        projectImageView.bottomAnchor.constraint(equalTo: loginRegisterSegmentedControl.topAnchor, constant: -40).isActive = true
        projectImageView.widthAnchor.constraint(equalToConstant: 240).isActive = true
        projectImageView.heightAnchor.constraint(equalToConstant: 240).isActive = true
    }
    ...
    func setupInputsContainerView() {
        ...
        profileImageView.topAnchor.constraint(equalTo: passwordSeparatorView.bottomAnchor, constant: 2).isActive = true
        profileImageView.bottomAnchor.constraint(equalTo: inputsContainerView.bottomAnchor, constant: -2).isActive = true
        
        profileImageView.centerXAnchor.constraint(equalTo: inputsContainerView.centerXAnchor).isActive = true
        // profileImageView.centerYAnchor.constraint(equalTo: inputsContainerView.centerYAnchor).isActive = true
    ...
    func setupTipsLabel() {
        ...
        tipsLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -32).isActive = true
        tipsLabel.leftAnchor.constraint(equalTo: view.leftAnchor).isActive = true
